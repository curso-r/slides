...
Dicas:
  1. A renda total é dada pelo produto da renda por cabeça e o número de cabeça.
...
Obtenha: 
    ...
    - As médias de IDH separadas por faixa de renda total.

Dicas:
    1. A função `cut` transforma um vetor em faixas de mesmo tamanho. Observa o resultado de `cut(1:10, breaks = 2, labels = F)`

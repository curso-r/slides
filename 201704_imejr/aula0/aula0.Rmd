...
### **Aula 01** - 25/05: Introdução ao R, Rstudio e `tidyverse`
...
### **Aula 02** - 27/05: Manipulação de vetores com `lubridate`, `stringr` e `forcats`, e funcionais com `purrr` e `plyr`
...
### **Aula 02** - 27/05: Manipulação de dados com `dplyr` e `tidyr`
